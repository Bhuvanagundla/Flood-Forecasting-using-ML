...
uploadButton.place(x=300, y=440)
uploadButton.config(font=font1)

pathlabel = Label(main)
pathlabel.config(bg='DarkOrange1', fg='white')
pathlabel.config(font=font1)
pathlabel.place(x=600, y=450)
...
open_second_button.place(x=320, y=500)
...
open_second_button.place(x=570, y=500)
open_second_button.config(font=font1)
...
splitButton.place(x=1050, y=500)
splitButton.config(font=font1)
...
show_results_button.place(x=650, y=580)
...
open_second_button.place(x=880, y=580)
open_second_button.config(font=font1)
...
def predict():
    ...
    print("===>", records)
    value = rf_classifier.predict(records)
    print("result of Random Forest is :" + str(value))
    text.insert(END,"\n\n")
    text.insert(END, "Result Of Random Forest is : " + str(value) + "\n\n")


# Predict Button
open_second_button = tk.Button(main,font=(13), text="Predition", command=predict)
open_second_button.place(x=650, y=650)
open_second_button.config(font=font1)
